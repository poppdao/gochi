    ...
    <section className="relative py-20">
      ...
      <div className="container px-4 mx-auto text-center">
        ...
        <div className="max-w-2xl mx-auto">
          <span className="inline-block mb-10 etxt-sm text-blue-400 font-semibold">Proof of Play Protocol (a.k.a 🍿 POPP)</span>
          <h2 className="mb-10 text-4xl font-semibold font-heading">🍿 POPP Score</h2>
          <p className="mb-16 text-lg text-gray-500">Given accountability score base on your 👻 <a className="text-purple-500" href="https://polygonscan.com/address/0x86935f11c86623dec8a25696e1c19a8659cbf95d" target="_blank" rel="noreferrer">Aavegotchi</a> on-chain activities</p>
          <form action="#">
